/* */ 
"use strict";
var MobileDetect = MobileDetect || require('../../mobile-detect'),
    mobilePerVendor = mobilePerVendor || require('../data/user-agents'),
    matchers;
function createMatcher(type) {
  return function(expected) {
    ...
    this.message = function() {
      ...
      return "Expected device" + (expected ? " " : " not ") + "to be " + type + " (" + additionalInfo.join(', ') + md.ua + ")";
    };
...
describe("MobileDetect (1 example)", function() {
  var aut;
  beforeEach(function() {
    aut = new MobileDetect('Mozilla/5.0 (Linux; U; Android 4.0.3; en-in; SonyEricssonMT11i Build/4.1.A.0.562)' + ' AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30', -1);
  });
...
describe("Extensibility", function() {
  ...
  it("should make internal 'prepareDetectionCache' possible to delegate", function() {
    var aut,
        UA = 'Mozilla/5.0 (Mobile; iPhone OS 7_0_3',
