...
function generateTestData() {
  ...
  out = ['/* This file was generated - do not edit! */', '/* hash = ' + uaList.hash + ' */', '', 'var mobilePerVendor =', JSON.stringify(mobilePerVendor, null, 4) + ';', '', 'if (typeof module !== "undefined") {', '    module.exports = mobilePerVendor;', '}'].join('\n');
